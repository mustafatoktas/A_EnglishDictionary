...
- Your feedback is highly valuable! For suggestions, questions or discussions use the
  [discussions page](https://github.com/mustafatoktas/A_EnglishDictionary/discussions).
  To report issues or bugs, visit the
  [issues page](https://github.com/mustafatoktas/A_EnglishDictionary/issues).
...
Before contributing, check the [existing issues](https://github.com/mustafatoktas/A_EnglishDictionary/issues) and
[open pull requests](https://github.com/mustafatoktas/A_EnglishDictionary/pulls). Someone might already be working on a similar topic.
